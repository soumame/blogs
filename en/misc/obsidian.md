---
title: "Isn't Obsidian incredibly useful?"
emoji: "🪨"
tags:
  - "dev"
  - "favourite-things"
...
Obsidian is incredibly useful.

## What is Obsidian
- The basic features are the same as Notion, and you write using [[markdown|Markdown]]
- Notion organizes data hierarchically, while Obsidian structures data through links between notes
- To be honest, Notion has more features, but Obsidian runs locally and is noticeably lighter than Notion
  - It was perfect for me, since I couldn't fully utilize Notion's features and wanted certain functionalities or an API
